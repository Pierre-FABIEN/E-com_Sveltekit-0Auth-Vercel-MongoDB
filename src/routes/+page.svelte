	...
	<div class="mx-auto mt-8 max-w-3xl px-4 sm:px-6 lg:px-8">
		<div class="space-y-6 rounded-md border p-4">
			...
			<div>
				...
				but you are encouraged to start from scratch, as long as you follow the requirements below:

				<ul class="mt-4 list-disc space-y-2 pl-4">
					<li>
						<span class="font-semibold">CRUD</span> - You should be able to create, read, update, and
						delete models specified in the schema below, ideally across different routes and pages designed
						for listing, viewing, and updating.
					</li>
					<li>
					...
					<li>
						...
						CSS to style your components. Put some thought into the design, layout, and navigation of
						your pages.
					</li>
				</ul>
			</div>

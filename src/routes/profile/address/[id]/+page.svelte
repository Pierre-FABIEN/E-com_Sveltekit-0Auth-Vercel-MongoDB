<script lang="ts">
	...
	import { updateAddressSchema } from '$server/address/Schema/addressSchema.js';
	...
	<form method="POST" action="?/updateAddress" use:enhance class="space-y-4">
		...
		<Form.Field name="recipient" form={updateAddress}>
			<Form.Control let:attrs>
				...
				<Input {...attrs} type="text" bind:value={$form.recipient} />
			</Form.Control>
			<Form.FieldErrors />
		</Form.Field>
		...
		<Form.Field name="street" form={updateAddress}>
			<Form.Control let:attrs>
				...
				<Input {...attrs} type="text" on:input={handleInput} bind:value={$form.street} />
			</Form.Control>
			<Form.FieldErrors />
		</Form.Field>
		...
		<Form.Field name="city" form={updateAddress}>
			<Form.Control let:attrs>
				...
				<Input {...attrs} type="text" on:input={handleInput} bind:value={$form.city} />
			</Form.Control>
			<Form.FieldErrors />
		</Form.Field>
		...
		<Form.Field name="state" form={updateAddress}>
			<Form.Control let:attrs>
				...
				<Input {...attrs} type="text" on:input={handleInput} bind:value={$form.state} />
			</Form.Control>
			<Form.FieldErrors />
		</Form.Field>
		...
		<Form.Field name="zip" form={updateAddress}>
			<Form.Control let:attrs>
				...
				<Input {...attrs} type="text" on:input={handleInput} bind:value={$form.zip} />
			</Form.Control>
			<Form.FieldErrors />
		</Form.Field>
		...
		<Form.Field name="country" form={updateAddress}>
			<Form.Control let:attrs>
				...
				<Input {...attrs} type="text" on:input={handleInput} bind:value={$form.country} />
			</Form.Control>
			<Form.FieldErrors />
		</Form.Field>
